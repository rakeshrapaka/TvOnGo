package com.freelance.rapaka.tvongo.view.slidemenu;
...
import com.freelance.rapaka.tvongo.R;
...
public class SideMenu extends FrameLayout {
    ...
    private List<SideMenuItem> rightMenuItems;
     ...
     */
    public SideMenu(Context context, int customLeftMenuId,
    ...
    public void setTitle(String title){
        if(title!=null) {
            TextView titleView = (TextView) findViewById(R.id.userName);
    ...
    private void initValue(Activity activity) {
        ...
        leftMenuItems = new ArrayList<SideMenuItem>();
        rightMenuItems = new ArrayList<SideMenuItem>();
    ...
    /**
     * The visibility of the shadowimg under the activity;
     *
     * @param isVisible
     */
     ...
     * @param direction
     */
    public void addMenuItem(SideMenuItem menuItem, int direction) {
     ...
     */
    @Deprecated
    public void setMenuItems(List<SideMenuItem> menuItems) {
     ...
     * @param direction
     */
    public void setMenuItems(List<SideMenuItem> menuItems, int direction) {
        if (direction == DIRECTION_LEFT)
            this.leftMenuItems = menuItems;
        rebuildMenu();
    }
    ...
    private void rebuildMenu() {
        if (layoutLeftMenu != null) {
            ...
            for (SideMenuItem leftMenuItem : leftMenuItems)
     ...
     * @return
     */
    public List<SideMenuItem> getMenuItems(int direction) {
        if (direction == DIRECTION_LEFT)
            return leftMenuItems;
        else
    ...
    public void openMenu(int direction) {
        ...
        isOpened = true;
        float nScaleValue = 0.7f;
        AnimatorSet scaleDown_activity = buildScaleDownAnimation(viewActivity, mScaleValue, nScaleValue);
        AnimatorSet scaleDown_shadow = buildScaleDownAnimation(imageViewShadow,
                mScaleValue + shadowAdjustScaleX, nScaleValue + shadowAdjustScaleY);
    ...
    public void setSwipeDirectionEnable() {
        ...
        disabledSwipeDirection.add(DIRECTION_RIGHT);
    }
    ...
    private void setScaleDirection(int direction) {
        ...
        ViewCompat.setPivotX(viewActivity, pivotX);
        ViewCompat.setPivotY(viewActivity, pivotY);
        ViewCompat.setPivotX(imageViewShadow, pivotX);
        ViewCompat.setPivotY(imageViewShadow, pivotY);
    ...
    private float getTargetScale(float currentRawX) {
        ...
        float targetScale = ViewCompat.getScaleX(viewActivity) - scaleFloatX;
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        float currentActivityScaleX = ViewCompat.getScaleX(viewActivity);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (pressedState == PRESSED_DOWN) {
                    ...
                    if (mUse3D) {
                        ...
                        ViewCompat.setRotationY(viewActivity, angle);

                        ViewCompat.setScaleX(imageViewShadow, targetScale - shadowAdjustScaleX);
                        ViewCompat.setScaleY(imageViewShadow, targetScale - shadowAdjustScaleY);
                    } else {
                        ViewCompat.setScaleX(imageViewShadow, targetScale + shadowAdjustScaleX);
                        ViewCompat.setScaleY(imageViewShadow, targetScale + shadowAdjustScaleY);
                    }
                    ViewCompat.setScaleX(viewActivity, targetScale);
                    ViewCompat.setScaleY(viewActivity, targetScale);
                    ViewCompat.setAlpha(scrollViewMenu, (1 - targetScale) * 2.0f);
